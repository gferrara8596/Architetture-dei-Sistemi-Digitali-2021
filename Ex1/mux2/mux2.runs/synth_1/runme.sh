...
HD_PWD='/home/giuseppe/Scrivania/mux2/mux2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rete.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rete.tcl

...
HD_PWD='/home/giuseppe/Scrivania/mux2/mux2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rete.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rete.tcl -notrace
